...
function observer(){
  ...
  <ul>
    ...
    <li>1. Haz clic en el botón "Quiero registrar..." en la parte superior para proceder al registro del/la menor de edad a tu cargo.</li>
    <li>2. Una vez registrado, tendrás acceso a descargar la documentación legal, solo escribe tu correo registrado y haz clic en "Descargar documentos",
      una vez descargado el documento en formato PDF, debes imprimirlo y firmarlo.</li>
    <li>3. Revisa y completa la documentación que se describe al final del documento descargado, y adjúntala a los documentos que entregarás a tu diputado.</li>
    <li>4. Repite el proceso por cada menor que desees registrar.</li>
  <ul>
 </div> </div>
